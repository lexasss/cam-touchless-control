...
{
    public static DShowCamera[] Get()
    {
        var cameras = new List<DShowCamera>();
        ...
        for (int drv = 0; drv < _drivers.Length; drv++)
        {
            ...
            for (int idx = 0; idx < MaxID; idx++)
            {
                ...
                if (cap.IsOpened())
                {
                    ...
                    {
                        cameraDevice = cameraDevices[cameraDeviceIndex++];
                    }
        ...
        System.Diagnostics.Debug.WriteLine($"{cameras.Count} cameras has been found ");
